...
FORECLOSURE_STATE = (
    ...
    "with the auction itself no sooner than twenty days later &mdash; about 111 days "
...
"san-diego-county": dict(
    recorder=dict(
        ...
        html=("The county Assessor/Recorder/County Clerk records deeds at five "
              ...
              "county&rsquo;s online records index &mdash; looking up a property&rsquo;s recorded "
    ...
    dtt=dict(
        h="Transfer tax",
        html=("Documentary transfer tax is $0.55 per $500 of price &mdash; $550 on a "
              "$500,000 house &mdash; and none of the cities we buy in add a city tax "
    ...
    stock=dict(
        h="The housing stock",
        html=("Three markets wearing one county&rsquo;s name. East County &mdash; El Cajon, "
              "La Mesa, Santee, Lemon Grove &mdash; is dominated by 1950s&ndash;70s "
              ...
              "Permit before it changes shape &mdash; which is one reason small old "
    ...
    killers=dict(
        ...
        html=("Unpermitted additions and garage conversions surface at "
              "inspection constantly &mdash; East County especially. Mello-Roos in "
...
"riverside-county": dict(
    recorder=dict(
        ...
        html=("The Assessor&ndash;County Clerk&ndash;Recorder records countywide, with "
              ...
              "pursues transfer tax on <em>unrecorded</em> changes of ownership &mdash; "
              "entity transfers included &mdash; so &ldquo;we just won&rsquo;t record it&rdquo; is not "
              "a strategy here."),
    ...
    dtt=dict(
        ...
        html=("Countywide the rate is $0.55 per $500. Inside the city of "
              "Riverside it doubles to $1.10 per $500 &mdash; the county&rsquo;s own "
              "information sheet prints it in bold. Temecula, Murrieta and "
              "Perris charge no city add-on. On a $500,000 sale that&rsquo;s $550 "
              "in Temecula and $1,100 in the city of Riverside &mdash; worth knowing "
    ...
    probate=dict(
        ...
        html=("Where your case is heard depends on where you live: the "
              ...
              "serves Temecula, Murrieta and the surrounding valley &mdash; useful, "
              "because it means a Temecula probate doesn&rsquo;t mean driving to "
              "Riverside. Filings go through the court&rsquo;s eSubmit portal, and "
    ...
    stock=dict(
        h="The housing stock",
        html=("Southwest Riverside is overwhelmingly 1985&ndash;2010 tract housing &mdash; "
              ...
              "is a different animal &mdash; genuinely old neighbourhoods like the "
    ...
    killers=dict(
        ...
        html=("Two liens ride on tax bills here more than anywhere else we "
              ...
              "solar and efficiency loans were <em>invented</em> here &mdash; the HERO "
              "programme launched with the Western Riverside Council of "
              "Governments in 2011 &mdash; so a striking share of local houses carry "
...
"san-bernardino-county": dict(
    recorder=dict(
        ...
        html=("The Assessor&ndash;Recorder&ndash;Clerk records at the Hall of Records in "
              ...
              "same-day e-recording through authorised submitters &mdash; which in "
    ...
    dtt=dict(
        ...
        html=("Documentary transfer tax is the standard $0.55 per $500 of "
              "price, and none of the cities we buy in &mdash; San Bernardino, "
              "Fontana, Rancho Cucamonga, Redlands, Highland &mdash; levy a city "
              "tax on top."),
        src="https://arc.sbcounty.gov/document-recording/",
        srcname="SB County Assessor-Recorder-Clerk"),
    probate=dict(
        ...
        html=("Since February 2024, probate isn&rsquo;t heard in downtown San "
              ...
              "the Fontana and Victorville districts. Probate notes &mdash; the "
              "examiner&rsquo;s to-fix list for your petition &mdash; post to the court&rsquo;s "
    ...
    stock=dict(
        ...
        html=("The valley floor tells its age in decades: prewar and postwar "
              ...
              "older half is where inspection findings cluster &mdash; galvanised "
    ...
    killers=dict(
        h="What kills deals here",
        html=("In the High Desert &mdash; Phelan, Pi&ntilde;on Hills, the unincorporated "
              "fringe &mdash; water and waste are private: wells, septic tanks, and "
              ...
              "valley floor it&rsquo;s the older-stock trio above &mdash; plumbing, "
              "wiring, panels &mdash; that resets buyers&rsquo; numbers at inspection."),
...
"kern-county": dict(
    recorder=dict(
        ...
        html=("Kern still does recording the old way: at the counter, 1530 "
              ...
              "money order &mdash; no cards. The county&rsquo;s own published timelines "
              "say originals come back in three to four weeks for walk-ins "
              "and four to six by mail. Title companies handle this in a "
              "normal escrow, but if you&rsquo;re clearing paperwork yourself &mdash; an "
              "affidavit of death, a quitclaim &mdash; build those weeks into the "
              "plan."),
    ...
    dtt=dict(
        ...
        html=("The rate is the standard $0.55 per $500, but Kern computes it "
              ...
              "whichever is greater</em> &mdash; the county&rsquo;s recording page says so in "
    ...
    probate=dict(
        ...
        html=("Kern files probate somewhere nobody guesses: the Juvenile "
              "Justice Center at 2100 College Avenue in Bakersfield &mdash; "
    ...
    stock=dict(
        h="The housing stock",
        html=("Bakersfield&rsquo;s core &mdash; central, east, Oleander, La Cresta &mdash; is "
              ...
              "towns &mdash; Shafter, Wasco, Tehachapi, Ridgecrest &mdash; age and "
    ...
    killers=dict(
        ...
        html=("Water and what&rsquo;s under the ground. Rural and ag-adjacent "
              ...
              "are severed from the surface on much of the county &mdash; usually "
...
"san-diego-county": (
    ...
    "Protections Ordinance (June 2023) with relocation payments &mdash; typically "
    "two months&rsquo; rent &mdash; on no-fault terminations. Selling with the tenant in "
...
"riverside-county": (
    ...
    "county stock is often young enough to sit outside AB&nbsp;1482 &mdash; check the "
...
"san-bernardino-county": (
    ...
    "older rental stock. The practical issue we see isn&rsquo;t the law &mdash; it&rsquo;s "
...
"kern-county": (
    ...
    "fine &mdash; the housing authority relationship transfers with ownership, and "
