...
("san-diego-county", "sell-my-house-fast"):
  ...
  "their answer beats ours, take it. We mean that, and the fact that almost nobody else in this "
...
("san-diego-county", "inherited-house"):
  ...
  "you weeks to gather real numbers: ours in writing, an agent&rsquo;s in writing, and the estate "
...
("san-diego-county", "sell-rental-property"):
  "<p>If your building is in one of the county&rsquo;s other cities (Chula Vista, El Cajon, La Mesa) "
...
("riverside-county", "inherited-house"):
  ...
  "weekly. Vacant houses in tract neighbourhoods draw attention: HOA letters first, worse "
...
("riverside-county", "sell-rental-property"):
  "<p>And if the rental is the house you yourself lived in before moving up or out (the classic "
  "southwest-county story), check with a CPA about the capital-gains exclusion clock before "
...
("san-bernardino-county", "sell-my-house-fast"):
  ...
  "used, which makes lazy lowballing impossible to disguise, including ours.</p>",
("san-bernardino-county", "inherited-house"):
  ...
  "obligations: a reverse mortgage, a HELOC from 2006, sometimes an old judgment lien nobody "
  "mentioned. None of these stop a sale; all of them come out of the proceeds through escrow. "
  "Pull a preliminary title report early. We&rsquo;ll arrange it at no cost, so the estate plans "
...
("san-bernardino-county", "sell-rental-property"):
  ...
  "before closing. We don&rsquo;t need the well tested to a lender&rsquo;s standard to commit. We test "
...
("kern-county", "sell-my-house-fast"):
  ...
  "payrolls, Tehachapi on the pass economy, Ridgecrest on the base, and each has streets "
...
("kern-county", "inherited-house"):
  ...
  "never refinanced, meaning title is clean but paperwork is ancient. A deed in a maiden "
  ...
  "months, and remember the recorder&rsquo;s counter timeline when planning them.</p>",
("kern-county", "sell-rental-property"):
  ...
  "When their assumptions crack: a turnover, a big system bill. They renegotiate or vanish. "
...
("san-bernardino-county", "stop-foreclosure"):
  ("I&rsquo;m behind on property taxes too. Is that a second foreclosure?",
   "<p>It&rsquo;s a second, slower clock: tax-defaulted property becomes subject to the county&rsquo;s power to sell after five years of delinquency, separate from your lender&rsquo;s process. The good news: tax arrears redeem through escrow in any sale, and five years is a far kinder timeline than 111 days. List both debts when you tally where you stand.</p>"),
("san-bernardino-county", "sell-rental-property"):
  ("It&rsquo;s rented by the room with nothing in writing. Can that even be sold?",
   "<p>Yes. Informal arrangements are still tenancies in California (month-to-month by operation of law), and they transfer like any other. We document what exists honestly (who pays what, since when), price around it, and handle the human side lawfully after close. It&rsquo;s a worse situation to keep than to sell.</p>"),
("kern-county", "sell-my-house-fast"):
  ("Half the houses here cool with swamp coolers. Do you mark that down?",
   "<p>We price it as the system it is: evaporative cooling is normal for Kern&rsquo;s climate and buyers here expect it. What moves the number isn&rsquo;t the cooler on the roof, it&rsquo;s the condition of what&rsquo;s under it: roof penetrations, duct state, and whether summer electrical load has been doing damage. That&rsquo;s a walkthrough question, not a penalty.</p>"),
("kern-county", "inherited-house"):
  ("The estate includes oil royalty payments tied to the land. What happens to those?",
   "<p>Usually they&rsquo;re severed rights the estate can keep or distribute separately from the house. Selling the surface doesn&rsquo;t automatically sell the minerals, and Kern title reads this clearly. Tell your probate attorney they exist so the inventory captures them; on our side, the house sale simply proceeds around them.</p>"),
("kern-county", "stop-foreclosure"):
  ("My income is seasonal (oilfields, ag). Do lenders account for that?",
   "<p>Loss-mitigation departments can, if you ask formally. Forbearance and modification programmes exist precisely for income interruption, and a HUD counsellor can help you present seasonal income properly. Start that conversation in writing, early. If the numbers still don&rsquo;t work, a controlled sale beats an auction, and we&rsquo;ll tell you honestly which side of that line your numbers sit.</p>"),
("kern-county", "sell-rental-property"):
  ("My tenants pay cash and there&rsquo;s no written lease. Deal-breaker?",
   "<p>No: a cash month-to-month tenancy is still a tenancy, and it transfers like any other. We&rsquo;ll document the terms that exist with a simple estoppel (who lives there, what they pay, since when), price the building on the real rent, and take over the relationship lawfully. No drama required, least of all for the tenant.</p>"),
}
...
("san-diego-county", "sell-my-house-fast"): dict(
  ...
  lede="This is our home county. A call in the morning is usually a walkthrough the same week: often the same day.",
  intro=(
    ...
    "once. On a seventy-year-old house those aren&rsquo;t three surprises. They&rsquo;re "
    ...
    "finished value, the renovation budget and the margin, and if a "
  ...
  narr=(
    ...
    "addition or a DIY kitchen doesn&rsquo;t add value on the open market. It adds "
    ...
    "refused. All priced in, none of it yours to fix.</p>"
    ...
    "title is clean, and this county&rsquo;s title records are the one place "
  ...
  faq=[
    ("How fast can you actually close in San Diego County?",
     "<p>With clean title, about two weeks from first call, and the walkthrough usually happens within a day or two because this is home. Liens or probate add time, but that&rsquo;s the paperwork, not us.</p>"),
    ("The house has an unpermitted addition. Problem?",
     "<p>Common here, especially in East County. It changes the number. We price the cost of legalising or removing it, but it doesn&rsquo;t stop the sale. Bring whatever paperwork exists and we&rsquo;ll sort out the rest.</p>"),
    ("Do I pay transfer tax when I sell to you?",
     "<p>The county documentary transfer tax is $0.55 per $500 of price, and no San Diego County city we buy in adds its own on top. Who pays it is negotiable in the offer, and unlike commissions, it&rsquo;s the only percentage in the deal.</p>")],
),
...
("san-diego-county", "inherited-house"): dict(
  ...
  lede="The probate calendar downtown moves at its own pace. We work to the court&rsquo;s timeline, not against it, and the house can wait full of everything it holds.",
  intro=(
    ...
    "sets the tempo: petitions are examined before they&rsquo;re heard, examiners "
  ...
  narr=(
    ...
    "&ldquo;fix it up first&rdquo;, but a repipe, a rewire and a roof on a house you "
    ...
    "attorney, not to a buyer. We&rsquo;ll work to whatever they say.</p>"),
  faq=[
    ("Where is probate actually handled here?",
     "<p>At the Central Courthouse, 1100 Union Street, downtown San Diego. Probate for the whole county is heard there. Your attorney files electronically; hearings are typically set weeks out, so build the calendar around that.</p>"),
    ("Can you buy before the probate is finished?",
     "<p>Sometimes. It depends on the authority the court granted the representative and how title was held. With full independent authority, often yes; with limited authority, the sale may need court confirmation. Ask your probate attorney; we&rsquo;ll fit either path.</p>"),
    ("The house is full and I live out of state. Realistically, what do I do?",
     "<p>Realistically: nothing. We buy contents-in-place constantly: furniture, garage, paperwork, all of it. You take what matters by shipping box or by one trip, and the rest is our job, not yours.</p>")],
),
...
("san-diego-county", "stop-foreclosure"): dict(
  ...
  lede="The letters make it sound like next week. The statute says otherwise, and knowing where you actually stand is worth more than any offer.",
  intro=(
    "<p>A Notice of Default recorded against a San Diego County house starts "
    "the same statutory clock as everywhere in California: three months to "
  ...
  narr=(
    ...
    "outcome on the table. Auction bidders price in their risk, and what "
    ...
    "been filed against your house takes one records check, and since "
  ...
  faq=[
    ("How much time do I really have?",
     "<p>Count from the recording date of the Notice of Default: three months before a sale can be noticed, then at least twenty more days before an auction, and the recorded documents, not the collection letters, are the truth of where you are. We can help you confirm what&rsquo;s actually on file.</p>"),
    ("Can I sell after a sale date is set?",
     "<p>Often, yes. Right up until the auction actually happens, a sale that pays the lender off in escrow stops the process. It gets tight and title has to move fast, which is one reason a cash buyer with a San Diego escrow team matters at that stage. Sooner is better; the last week is a bad plan.</p>"),
    ("Is talking to you a foreclosure-rescue service?",
     "<p>No. California regulates foreclosure consultants; we are not one, we charge nothing at any point, and we don&rsquo;t take fees to &ldquo;help.&rdquo; We buy houses as a principal. If buying yours makes sense we&rsquo;ll offer; if it doesn&rsquo;t, we&rsquo;ll tell you what we&rsquo;d do in your place, and a HUD-approved counsellor is free and on your side either way.</p>")],
  legal=True,
),
...
("san-diego-county", "sell-rental-property"): dict(
  ...
  intro=(
    ...
    "Diego the 2023 Tenant Protections Ordinance goes further: no-fault "
    "terminations come with relocation payments, typically two months&rsquo; rent, "
    "and the ordinance is enforced. The traditional advice (&ldquo;get the unit "
    "vacant, renovate, then list&rdquo;) now means months of carrying costs plus "
    ...
    "out at a number you saw the math on, without ever serving a notice.</p>"),
  ...
  narr=(
    ...
    "that path to net less than an honest occupied price, before counting "
  ...
  faq=[
    ("Does the city&rsquo;s ordinance apply to my rental?",
     "<p>If the property is inside San Diego city limits, very likely: the 2023 ordinance covers most tenancies, with relocation payments on no-fault terminations. County-area and other-city rentals answer mainly to state law. Either way, selling with the tenant in place means the question never gets tested.</p>"),
    ("My tenant is behind on rent. Can I still sell?",
     "<p>Yes. Arrears, a payment plan, even an eviction already in motion. We&rsquo;ve bought through all of it. The situation gets priced honestly and handled after close by us, within the law, rather than by you under deadline.</p>"),
    ("Do I have to tell my tenant I&rsquo;m selling?",
     "<p>You have to respect notice rules for any entry. We schedule the single walkthrough legally and around their day. There&rsquo;s no requirement to market the sale to them, and because nobody is being displaced, the conversation is usually easier than landlords fear.</p>")],
),
...
("riverside-county", "sell-my-house-fast"): dict(
  ...
  intro=(
    ...
    "usually 1985&ndash;2010 tract (Temecula, Murrieta, Perris), and what&rsquo;s "
    ...
    "the systems budget, the margin, and the offer doesn&rsquo;t shrink at "
  ...
  narr=(
    ...
    "anywhere else we work, and it&rsquo;s not the sellers&rsquo; fault. PACE/HERO "
    ...
    "through escrow, and a buyer who discovers them in week four is a "
    ...
    " which is worth knowing before comparing offers net-to-net.</p>"),
  faq=[
    ("There&rsquo;s a solar loan on the house. Can you still buy it?",
     "<p>Yes. This is the county where solar liens were invented, and we deal with them weekly. Leased panels, owned-but-financed, PACE assessments on the tax bill: each has a clean path through escrow. Bring whatever paperwork you have and we&rsquo;ll identify which one you&rsquo;ve got.</p>"),
...
("riverside-county", "inherited-house"): dict(
  ...
  lede="Which courthouse hears the estate depends on where the house sits, and for the southwest county, that&rsquo;s Murrieta, not a drive downtown.",
  intro=(
    ...
    "For heirs, that geography is good news: a Temecula estate is handled "
  ...
  narr=(
    ...
    "sale gets confirmed in court, and this county runs its overbid "
    ...
    "title report, not as a crisis, just as line items the offer already "
    "accounts for.</p>"),
  faq=[
    ("Which court will the estate go through?",
     "<p>By region: southwest-county houses (Temecula, Murrieta, the valley) are heard at the Southwest Justice Center in Murrieta; western-county houses at the Historic Courthouse downtown. Your attorney files either way through the court&rsquo;s eSubmit portal.</p>"),
    ("What if the court has to confirm the sale?",
     "<p>Then the hearing includes the county&rsquo;s overbid procedure: open competitive bidding above our accepted offer, on the court&rsquo;s local form. It adds a few weeks and can only raise the estate&rsquo;s proceeds. We&rsquo;re comfortable with it and will walk you through what to expect.</p>"),
    ("Grandma&rsquo;s house has solar panels she financed. Whose problem is that now?",
     "<p>The estate&rsquo;s, technically, but practically, ours to solve in escrow. Financed panels and PACE assessments follow the property, get paid or subordinated at close, and are priced into the offer so there&rsquo;s no late surprise for the heirs.</p>")],
),
...
("riverside-county", "stop-foreclosure"): dict(
  ...
  lede="Same statewide clock as everywhere, with one local twist: the other liens on the tax bill, and what they do to your real number.",
  intro=(
    ...
    "any auction: about 111 days minimum, usually more. Use the early "
    ...
    "tracts, Mello-Roos, which changes both your payoff math and what a "
  ...
  narr=(
    ...
    "dollar. A controlled sale prices the same stack transparently. We "
    "show the payoff lines one by one, and what&rsquo;s left is genuinely "
  ...
  faq=[
    ("What&rsquo;s actually recorded against my house?",
     "<p>The Notice of Default and any sale notice are public records with the county recorder, and your full lien picture (mortgage, PACE, special taxes) shows in a preliminary title report. We&rsquo;ll help you pull both so you&rsquo;re planning from facts. No charge, no obligation.</p>"),
    ("Can a sale still happen if there&rsquo;s no equity left after everything?",
     "<p>Sometimes: a short sale with lender approval, but that&rsquo;s a lender-and-counsellor conversation first, and we&rsquo;ll say so honestly rather than string you along. Where there is equity, which is common here, a pre-auction sale protects it.</p>"),
    ("Are you a foreclosure consultant?",
     "<p>No, and California law is strict about who is. We charge no fees, offer no rescue services, and buy property only as a principal. Free help exists: a HUD-approved housing counsellor can review every option with no stake in your answer, and we&rsquo;ll tell you the same thing on the phone.</p>")],
  legal=True,
),
...
("riverside-county", "sell-rental-property"): dict(
  ...
  intro=(
    ...
    "home for a decade. Now the owner is done, and discovers the exit the "
  ...
  narr=(
    ...
    "hide this. Nobody calls about the roof until it leaks, so we "
    ...
    "assessment riding on it, and out here there often is. We price "
  ...
  faq=[
    ("My tenant&rsquo;s lease runs another 14 months. Do I wait?",
     "<p>No: the lease conveys with the property. We step into it exactly as written, terms and deposit intact, and the tenant&rsquo;s situation on the day after closing looks identical to the day before, minus the deferred maintenance.</p>"),
    ("Is my newer rental even covered by AB 1482?",
     "<p>Much of the southwest county&rsquo;s stock is young enough that the state law&rsquo;s fifteen-year rolling exemption matters, so check the certificate-of-occupancy date rather than guessing. Either way it doesn&rsquo;t change our process: we buy occupied and nobody needs terminating.</p>"),
...
("san-bernardino-county", "sell-my-house-fast"): dict(
  ...
  lede="Half this county&rsquo;s housing tells its age at inspection: wiring, panels, plumbing. We price it like the builders we are and skip the theatre.",
  intro=(
    ...
    "Redlands and Highland these aren&rsquo;t defects so much as the era, and "
  ...
  narr=(
    ...
    "it&rsquo;s a different transaction: wells, septic, and a county health "
    ...
    "The number reflects the house as it stands, and the math behind it "
    "is on the table, not behind a curtain.</p>"),
  faq=[
    ("The insurance company just non-renewed over the electrical panel. Can you still buy?",
     "<p>Yes. Federal Pacific and Zinsco panels are a known quantity for us; the panel swap is in our renovation budget before we ever see yours. Your sale doesn&rsquo;t need the insurer&rsquo;s blessing; our purchase doesn&rsquo;t either.</p>"),
    ("My house is on a well and septic near Phelan. Does that slow you down?",
     "<p>Less than it slows anyone else. County health wants its paperwork (percolation records for septic work, and buyers typically want well tests), but as a cash buyer we&rsquo;re not waiting on a lender&rsquo;s checklist. We test for our own information and close on schedule.</p>"),
...
("san-bernardino-county", "inherited-house"): dict(
  ...
  lede="Probate here moved. Fontana and Victorville hear the county&rsquo;s estates now. The house, meanwhile, can wait exactly as it is.",
  intro=(
    ...
    "Decedents&rsquo; estates are filed and heard in Fontana, or Victorville "
    "for the High Desert, and the examiner&rsquo;s &ldquo;probate notes&rdquo; on your "
  ...
  narr=(
    ...
    "underestimate how much these complicate a financed sale (well "
    "tests, septic pump-and-certify, county health paperwork), and "
  ...
  faq=[
    ("Where does the estate get filed now?",
     "<p>Fontana District for most of the county, Victorville for the High Desert. Downtown San Bernardino stopped hearing probate in February 2024. Your attorney will know; if you&rsquo;re doing it yourself, check the court&rsquo;s &ldquo;where probate cases are filed&rdquo; order before driving anywhere.</p>"),
    ...
    ("The family house is in Phelan on a well. Will that sink the estate sale?",
     "<p>No. It narrows the buyer pool to people who understand wells and septic, which is a category we&rsquo;re squarely in. We price the infrastructure honestly, handle the county-health paperwork, and don&rsquo;t need a lender&rsquo;s comfort to close.</p>")],
),
...
("san-bernardino-county", "stop-foreclosure"): dict(
  ...
  lede="The clock is state law. What you do with it (reinstate, negotiate, sell, or get counselled) is the part you still control.",
  intro=(
    ...
    "and at least twenty more days before an auction: roughly 111 days "
  ...
  narr=(
    ...
    "first-time buyers could actually buy, which means many defaults "
    ...
    "<p>If the arithmetic is thinner (recent purchase, low equity), "
  ...
  faq=[
    ("How do I find out exactly what&rsquo;s been recorded?",
     "<p>The NOD and any sale notice are public at the county recorder: the office e-records same-day, so the record is current. We&rsquo;ll pull what&rsquo;s filed against your address and read you the actual dates, free, whether or not we ever talk again.</p>"),
    ("The house needs work I can&rsquo;t afford. Does that close the sale option?",
     "<p>No. It just changes which buyers are real. This county&rsquo;s older stock in default often needs the classic trio (wiring, panel, plumbing), which financed buyers struggle with on a deadline. We price the work in and close on the calendar you&rsquo;re actually facing.</p>"),
    ("Someone offered to &ldquo;take over my payments.&rdquo; Should I?",
     "<p>Be very careful. Subject-to arrangements on a house in default are where sellers get hurt, and California law regulates equity purchases from owners in foreclosure for exactly that reason. Have any such offer read by an attorney or HUD counsellor first. Our approach is the boring one: a recorded sale, escrow, your payoff shown line by line.</p>")],
  legal=True,
),
...
("san-bernardino-county", "sell-rental-property"): dict(
  ...
  lede="A decade of deferred maintenance between tenancies is normal here. We price it plainly. You don&rsquo;t fix it, and nobody gets displaced.",
  intro=(
    ...
    "grown to a renovation, and the owner is being told to empty the "
  ...
  narr=(
    ...
    "condition: tenants report failures, not fatigue, so our number "
    ...
    "Everything else (the walkthrough inside legal notice rules, the "
    "deposit proration, the arrears conversation if there is one) is "
  ...
  faq=[
    ("My rental is in rough shape and occupied. Do you need it vacant to assess it?",
     "<p>No. One walkthrough, legally noticed and scheduled around your tenant, is enough, and where access is genuinely difficult we can work from era, exterior and what you can tell us, with the assumptions written into the offer.</p>"),
    ("It&rsquo;s a Section 8 tenancy. Does that complicate the sale?",
     "<p>It changes the paperwork, not the outcome. The housing-authority contract moves with ownership, inspections continue on their cycle, and the voucher is untouched. We&rsquo;ve carried Section 8 tenancies through closing repeatedly. It&rsquo;s routine.</p>"),
    ("Can I sell if I&rsquo;ve already started an eviction?",
     "<p>Yes. Disclose where the case stands and we&rsquo;ll price and plan around it. The matter transfers with the property and we resolve it lawfully after close. It&rsquo;s usually better for everyone than racing the courthouse.</p>")],
),
...
("kern-county", "sell-my-house-fast"): dict(
  ...
  intro=(
    ...
    "<p>The stock we buy most is Bakersfield&rsquo;s 1950s&ndash;70s core: same "
  ...
  narr=(
    ...
    "That&rsquo;s why some Kern &ldquo;fixer&rdquo; listings sit for months: the math "
...
("kern-county", "inherited-house"): dict(
  ...
  lede="Kern estates usually come with distance: heirs in San Diego or out of state, a house in Bakersfield, and a court system nobody knows.",
  intro=(
    "<p>Kern probate starts somewhere nobody guesses: the Juvenile Justice "
    "Center on College Avenue in Bakersfield. That&rsquo;s simply where the "
    ...
    "need emptying, checking on, or a local cousin managing keys. We "
  ...
  narr=(
    ...
    "central Bakersfield, original systems, full of a life, and four "
    ...
    "company&rsquo;s channel instead: same county, professional lane, no "
    "lost month.</p>"),
  faq=[
    ...
    ("The house has been empty for a year. Is that an issue?",
     "<p>It&rsquo;s a common one. Vacancy is hard on houses and insurance. It doesn&rsquo;t change our interest; it usually strengthens the case for selling as-is soon rather than after another winter. We price what the vacancy has done honestly.</p>"),
    ("Is there oil or mineral rights weirdness on Kern titles?",
     "<p>Often, and it&rsquo;s usually fine: mineral rights were severed from the surface on much of the county long ago. It&rsquo;s a title-report line we know how to read, not a crisis. It rarely affects a residential sale, and we&rsquo;ll flag it plainly if your title carries anything unusual.</p>")],
),
...
("kern-county", "stop-foreclosure"): dict(
  ...
  intro=(
    ...
    "margins for error, and, in the smaller towns especially, a "
    ...
    "lender workout, HUD-counselled plan, controlled sale: the full "
    "menu applies here, and the earlier weeks buy more than the later "
    "ones.</p>"),
  facts=("recorder", "stock", "dtt"),
  narr_h="Where the equity math lands here",
  narr=(
    "<p>Kern defaults split into two stories. Houses held for decades, "
    "common in Bakersfield&rsquo;s older core, often carry more equity than "
    ...
    "not a buyer. We&rsquo;ll say exactly that when it&rsquo;s true.</p>"
  ...
  faq=[
    ...
    ("Will you charge me anything to figure out my options?",
     "<p>Nothing, ever. California heavily regulates charging homeowners in foreclosure for help, and we&rsquo;re not in that business. We buy houses as a principal. The options conversation is free, and a HUD-approved counsellor is a free, no-stake second opinion we&rsquo;ll actively point you to.</p>")],
  legal=True,
),
...
("kern-county", "sell-rental-property"): dict(
  ...
  lede="Kern rentals earn steadily and age quietly. When you&rsquo;re done, the tenancy can transfer with the deed, voucher, deposit and all.",
  intro=(
    "<p>Kern&rsquo;s rental economics attracted a generation of landlords: "
    ...
    "<p>We&rsquo;re the buyer that pool is missing. The tenancy (lease terms, "
    "deposit, the housing-authority contract if there is one) transfers "
  ...
  narr=(
    ...
    "lived in Kern: bought for the yield from LA or San Diego, managed "
    ...
    "<p>Condition-wise we assume Kern&rsquo;s eras honestly: 1950s&ndash;70s core "
  ...
  faq=[
    ("My tenant has been there eleven years and pays under market. Does that tank the price?",
     "<p>It shapes it honestly rather than tanks it. We underwrite the actual rent, not a fantasy rent, and a long, stable tenancy is worth something real to a buyer who intends to keep the building running. What we won&rsquo;t do is price it assuming a displacement we have no intention of causing.</p>"),
    ("The housing authority inspection is due next month. Sell before or after?",
     "<p>Either works: the contract and inspection cycle transfer with ownership, and we&rsquo;ve taken buildings mid-cycle. If the inspection is likely to write up deferred items, selling before simply means those items are ours to cure, which is rather the point.</p>"),
    ("It&rsquo;s vacant between tenants and I don&rsquo;t want to re-let. Still interested?",
     "<p>Yes: a vacant Kern rental is carrying insurance and utilities against no income, which is its own clock. We can move at vacancy speed: walkthrough this week, close in about two.</p>")],
),
}
